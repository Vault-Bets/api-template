export const idlFactory = ({ IDL }) => {
  ...
  const Event = IDL.Service({
    ...
    'getBetTypeTradedAmount' : IDL.Func([BetType], [IDL.Nat], []),
    'getCaller' : IDL.Func([], [IDL.Principal], []),
    'getCommission' : IDL.Func([], [IDL.Nat], ['query']),
    'getEventDetails' : IDL.Func([], [InitEventDetails], ['query']),
    'getGraphData' : IDL.Func([], [IDL.Vec(GraphData)], []),
    'getMarketNames' : IDL.Func([], [IDL.Vec(IDL.Text)], ['query']),
    'getMarketTradedAmount' : IDL.Func([MarketID], [IDL.Nat], []),
    'getMatchedOrder' : IDL.Func([IDL.Text], [IDL.Opt(MatchedOrder)], []),
    'getOrder' : IDL.Func([IDL.Text], [IDL.Opt(ImmutableOrder)], []),
    'getOrderBook' : IDL.Func([MarketID], [IDL.Opt(OrderBookResponse)], []),
    'getOrderBooks' : IDL.Func([], [OrderBooksResponse], []),
    'getTotalTradedAmount' : IDL.Func([], [IDL.Nat], []),
    'getTransactionFee' : IDL.Func([], [IDL.Nat], ['query']),
    'getUserOrders' : IDL.Func([], [IDL.Vec(ImmutableOrder)], []),
