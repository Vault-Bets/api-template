...
export type Result_5 = { Ok: Array<Array<number>> } | { Err: GetBlocksError };
...
export interface _SERVICE {
  ...
  account_identifier: (arg_0: Account) => Promise<Array<number>>;
  ...
  query_encoded_blocks: (
    arg_0: GetBlocksArgs
  ) => Promise<QueryEncodedBlocksResponse>;
  send_dfx: (arg_0: SendArgs) => Promise<bigint>;
  symbol: () => Promise<Symbol>;
  transfer: (arg_0: TransferArgs) => Promise<Result_6>;
